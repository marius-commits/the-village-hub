...
exports.handler = async function (event) {
  ...
  try {
    ...
    // Security tokens from the Zoho Web Form "Village Hub Free Day Pass"
    ...
    // Zoho Web-to-Lead returns 200 with a JS redirect on success,
    // or a 3xx redirect — both indicate successful submission
